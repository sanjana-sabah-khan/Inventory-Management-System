...
//It is like a shopping cart. keeps product temporarily for adding or deleting before finalization

@Entity (name= "productselected")
@Table (name= "productselected")
public class OrderProductSelected {
